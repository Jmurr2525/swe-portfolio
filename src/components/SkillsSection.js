...
function SkillsSection() {
  const skills = [
    {
      title: "Dev Tools",
      items: ["Git", "Linux", "PyTorch", "Firebase"]
    },
    {
      title: "Languages",
      items: ["Python", "C++", "HTML/CSS", "JavaScript", "NodeJS"]
    },
    {
      title: "Areas of Interest",
      items: ["Machine Learning/AI applications", "Data extraction and manipulation", "Process Automation"]
    }
  ];
